...
namespace CrystalClearUniversal
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void Conservation_Btn(object sender, RoutedEventArgs e)
        {
        ...
        private void OneDrive_btn(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(OneDrive));
        }

        private void reading_Btn(object sender, RoutedEventArgs e)
        {
